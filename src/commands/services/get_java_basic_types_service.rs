use crate::{
  common::types::field_types::JavaBasicFieldTypeKind, responses::basic_java_type::BasicJavaType,
};

pub fn run(field_type_kind: &JavaBasicFieldTypeKind) -> Result<Vec<BasicJavaType>, String> {
  let types = if field_type_kind.eq(&JavaBasicFieldTypeKind::Id) {
    vec![
      BasicJavaType {
